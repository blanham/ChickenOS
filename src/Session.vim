...
set shortmess=aoO
badd +1 thread/exec.c
badd +10 ./include/string.h
badd +305 ~/src/pintos/src/lib/stdio.c
badd +1 lib/stdio.c
...
1
normal! 0
tabedit include/kernel/thread.h
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 19 - ((0 * winheight(0) + 17) / 35)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
19
normal! 01l
tabedit include/mm/liballoc.h
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
240
normal! 0
tabedit include/kernel/fs/vfs.h
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
